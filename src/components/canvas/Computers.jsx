...
const ComputerCanvas = () => {
  ...
  useEffect(() => {
    ...
    //Add an event loistner for changes to the screen size
    const mediaQuery = window.matchMedia('(max-width: 500px)');

    //Set the unitail value of the 'isMobile' state variable
    setIsMobile(mediaQuery.matches);

    //Define a callbaclk function to handle changes to the media query
